...
const sanitizedTerminalCustomHTML = computed(() => terminalCustomHTML.value
  ? DOMPurify.sanitize(terminalCustomHTML.value, { USE_PROFILES: { html: true } })
  : '');
                   ...
                   >
                       ...
                       >
                           ...
                           <div
                               ...
                               v-if="sanitizedTerminalCustomHTML"
