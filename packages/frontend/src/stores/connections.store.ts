...
export const useConnectionsStore = defineStore('connections', {
    ...
    actions: {
        ...
        // +++ 获取 VNC 会话令牌 +++
        async getVncSessionToken(connectionId: number, width?: number, height?: number, temporaryPassword?: string): Promise<string | null> {
            ...
            try {
                ...
                const response = await apiClient.post<{ token: string }>(apiUrl, temporaryPassword ? { password: temporaryPassword } : {});
