...
export const tableDefinitions: TableDefinition[] = [
    ...
    { name: 'orchestration_jobs', sql: schemaSql.createOrchestrationJobsTableSQL },
    { name: 'orchestration_job_targets', sql: schemaSql.createOrchestrationJobTargetsTableSQL },
    { name: 'orchestration_playbooks', sql: schemaSql.createOrchestrationPlaybooksTableSQL },
    { name: 'orchestration_playbook_files', sql: schemaSql.createOrchestrationPlaybookFilesTableSQL },
